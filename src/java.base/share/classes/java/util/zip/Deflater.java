    ...
    public void setDictionary(ByteBuffer byteBuffer) {
        synchronized (zsRef) {
            ...
            if (byteBuffer.isDirect()) {
                final long address = ZipUtils.getBufferAddress(byteBuffer);
    ...
    public int deflate(byte[] b, int off, int len, int flush) {
        ...
        synchronized (zsRef) {
            ...
            if (input == null) {
                ...
                if (input.isDirect()) {
                    final long inputAddress = ZipUtils.getBufferAddress(input);
    ...
    public int deflate(ByteBuffer output, int flush) {
        ...
        synchronized (zsRef) {
            ...
            if (input == null) {
                inputPos = this.inputPos;
                if (output.isDirect()) {
                    final long outputAddress = ZipUtils.getBufferAddress(output);
                ...
                if (input.isDirect()) {
                    final long inputAddress = ZipUtils.getBufferAddress(input);
                    if (output.isDirect()) {
                        final long outputAddress = outputPos + ZipUtils.getBufferAddress(output);
